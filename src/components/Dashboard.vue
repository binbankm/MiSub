    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
      ...
      <div class="lg:col-span-1 space-y-6 lg:space-y-8">
        <div>
          ...
          <div v-else class="text-center py-16 text-gray-500 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
            ...
            <h3 class="text-xl font-bold gradient-text mb-2">没有订阅组</h3>
